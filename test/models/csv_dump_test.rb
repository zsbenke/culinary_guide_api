...
class CSVDumpTest < ActiveSupport::TestCase
  ...
  test "should list all available csv dumps" do
    ...
    filenames = ['restaurant_tests_csv_dump.csv', 'restaurants_csv_dump.csv']

    assert_equal 2, csv_dumps.count
  ...
  test "should list imported and non-imported csv dumps" do
    ...
    assert_equal 1, non_imported_csv_dumps.count
  ...
  test "should import records remapped to new tablename" do
    csv_dump = CSVDump.find('restaurant_tests_csv_dump.csv')
    csv_dump.import
